---
title: Marketing-Flexibilität - Skalierung von Nicht-Kreativen
description: Sehen Sie sich die Adobe Content Supply Chain-Tutorials an, manchmal kann eine Inhaltsanfrage ohne vollständige Kreativteam-/Studiomanagement bearbeitet werden. Adobe überträgt Tools den Marketingexperten und anderen potenziellen Inhaltserstellern, sodass die Erstellung von Inhaltsvarianten und -aktualisierungen schnell von einer erweiterten, breiteren Gruppe von Einzelanwendern ausgeführt werden kann, die mit der Inhaltsversorgungskette verbunden sind. Dadurch werden der Inhaltsdurchsatz und die Time-to-Market erheblich gesteigert.
...
* Schnelles Generieren von Inhalten für Schnellreaktionskampagnen
* Vorhandenen Inhalt neu mischen und Marke beibehalten
* Automatisierte Produktion von abgeleiteten Assets (Größe, Kanal)
...
<div class="columns is-multiline"><div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Using Smart Crop with AEM Assets Dynamic Media" tabIndex="0">
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/dynamic-media/images/smart-crop-feature-video-use.html?lang=de" title="Verwenden von smartem Zuschneiden mit AEM Assets Dynamic Media" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/21519?format=jpeg" alt="Verwenden von smartem Zuschneiden mit AEM Assets Dynamic Media">
        </a>
      </figure>
    </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-social-posters.html" title="Social-Poster mit Firefly erstellen" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3420533?format=jpeg" alt="Social-Poster mit Firefly erstellen">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-webinar-poster.html" title="Webinar-Poster mit Firefly erstellen" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-blog-graphics.html" title="Einfache Durchführung von Social-Media-Kampagnen" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>Erfahren Sie, wie Sie mithilfe von Adobe Firefly Text to Image im Adobe Expreß eindeutige Grafiken für die Mitarbeiterrekrutierung und das Onboarding von Inhalten erstellen können.</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/create-local-marketing.html" title="Erstellen von Flyer-Inhalten für Marketingkampagnen mit Firefly" tabindex="-1">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expressusecase/multi-channel-marketing-content.html" title="Marketing-Teams können Inhalte für mehrere Kanäle erstellen" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3424446?format=jpeg" alt="Marketing-Teams können Inhalte für mehrere Kanäle erstellen">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/content-automation/overview.html" title="Übersicht über die Inhaltsautomatisierung mit Creative Cloud-Services" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/333197?format=jpeg" alt="Übersicht über die Inhaltsautomatisierung mit Creative Cloud-Services">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/adobe-express.html" title="Integration mit Adobe Express" tabindex="-1">
